  ...
  template: `
    ...
    <mat-dialog-content>
      ...
      <mat-checkbox [(ngModel)]="confirmAuthorization">
        I confirm that I am authorized to enter into this subscription on behalf
        of the Client
      </mat-checkbox>
    </mat-dialog-content>
...
export class TermsConfirmationDialogComponent {
  ...
  constructor(
    private dialogRef: MatDialogRef<TermsConfirmationDialogComponent>,
  ) {}

  allChecked(): boolean {
    return (
      this.acceptedMSA && this.acknowledgedPrivacy && this.confirmAuthorization
    );
  }
