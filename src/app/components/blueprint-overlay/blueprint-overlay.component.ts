...
import {
  OverlayStateService,
  SelectableElement,
} from '../../services/overlay-state.service';
import {
...
export class BlueprintOverlayComponent {
  ...
  onElementClick(element: SelectableElement): void {
    this.overlayState.selectElement(element);
  }
  ...
  onMouseMove(event: MouseEvent): void {
    ...
    this.overlayState.setCursorPosition({
