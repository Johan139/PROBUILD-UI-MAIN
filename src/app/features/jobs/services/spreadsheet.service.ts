...
export class SpreadsheetService {
  ...
  public generateCsv(data: { [key: string]: any[] }, fileName: string): void {
    for (const sheetName in data) {
      if (Object.prototype.hasOwnProperty.call(data, sheetName)) {
        ...
        this.downloadFile(csvOutput, `${fileName}_${sheetName}.csv`, 'text/csv');
      }
    }
  }
  ...
  public generateExcel(data: { [key: string]: any[] }, fileName: string): void {
    ...
    workbook.Props = {
      ...
      Author: 'ProBuild AI',
      Comments: 'This is an AI-generated estimate for internal use only. Not reviewed or certified by a licensed professional. Do not rely for regulatory, permitting, or construction purposes without independent validation. ProBuild AI disclaims all liability.'
    };
