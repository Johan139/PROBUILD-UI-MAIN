export const userTypes = [
  {value:'GENERAL_CONTRACTOR', display:'General Contractor'},
  {value:'PROJECT_MANAGER', display:'Project Manager'},
  {value:'CHIEF_ESTIMATOR', display:'Chief Estimator'},
  {value:'GENERAL_SUPERINTENDANT', display:'General Superintendent'},
