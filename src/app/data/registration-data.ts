...
export const trades = [
  { value: 'ACOUSTICAL_CONTRACTORS', display: 'Acoustical Contractors' },
  { value: 'ASBESTOS_ABATEMENT', display: 'Asbestos Abatement' },
  { value: 'AUTOMATION_TECHNOLOGY', display: 'Automation/Technology' },
  { value: 'CARPENTRY_MLWK', display: 'Carpentry (MLWK)' },
  { value: 'COMMUNICATIONS', display: 'Communications' },
  { value: 'COMPUTER_FACILITIES', display: 'Computer Facilities' },
  { value: 'CONCRETE', display: 'Concrete' },
  { value: 'CONCRETE_DECORATIVE', display: 'Concrete (Decorative)' },
  { value: 'CONCRETE_POLISHING', display: 'Concrete Polishing' },
  { value: 'COUNTERTOPS', display: 'Countertops' },
  { value: 'CRANES', display: 'Cranes' },
  { value: 'CURTAIN_WALL', display: 'Curtain Wall' },
  { value: 'DISASTER_RECOVERY', display: 'Disaster Recovery' },
  { value: 'DOORS_HARDWARE', display: 'Doors & Hardware' },
  ...
  { value: 'FIRE_PROOFING', display: 'Fire Proofing' },
  { value: 'FIRE_PROTECTION', display: 'Fire Protection' },
  { value: 'FIRE_SPRINKLING', display: 'Fire Sprinkling' },
  { value: 'FLOORING', display: 'Flooring' },
  { value: 'FOUNDATION_DRILLING', display: 'Foundation Drilling' },
  ...
  { value: 'LANDSCAPING', display: 'Landscaping' },
  { value: 'LIGHTENING_PROTECTION', display: 'Lightening Protection' },
  { value: 'MASONRY', display: 'Masonry' },
  { value: 'MECHANICAL', display: 'Mechanical' },
  { value: 'MECHANICAL_INSULATION', display: 'Mechanical Insulation' },
  { value: 'METAL_DECK', display: 'Metal Deck' },
  { value: 'PAINT_DECORATE', display: 'Paint/Decorate' },
  { value: 'PAVING', display: 'Paving' },
  { value: 'PLUMBING', display: 'Plumbing' },
  { value: 'RIGGING_HAULING', display: 'Rigging/Hauling' },
  { value: 'ROOFING', display: 'Roofing' },
  { value: 'SCAFFOLDING', display: 'Scaffolding' },
  { value: 'SEALANTS', display: 'Sealants' },
  { value: 'SECURITY_SYSTEMS', display: 'Security Systems' },
  { value: 'SEWER', display: 'Sewer' },
  { value: 'SHEET_METAL_FABRICATION', display: 'Sheet Metal/Fabrication' },
  { value: 'SIGNAGE', display: 'Signage ' },
  { value: 'SITE_PREPARATION', display: 'Site Preparation' },
  { value: 'SOLAR', display: 'Solar' },
  { value: 'SPECIAL_CONSTRUCTION', display: 'Special Construction' },
  ...
  { value: 'WATERPROOFING', display: 'Waterproofing' },
...
export const supplierTypes = [
  ...
  { value: 'ARCHITECTURAL', display: 'Architectural' },
  { value: 'ATTORNEY_CONSTRUCTION', display: 'Attorney/Construction' },
  { value: 'BANKING_FINANCIAL', display: 'Banking/Financial' },
  { value: 'BARRICADES', display: 'Barricades' },
  ...
  { value: 'LABOR', display: 'Labor' },
  { value: 'LUMBER', display: 'Lumber' },
  { value: 'METALS', display: 'Metals' },
  { value: 'MOBILE_STORAGE', display: 'Mobile Storage' },
  { value: 'MOVING_TRUCKING', display: 'Moving / Trucking' },
  ...
  { value: 'STAFFING', display: 'Staffing' },
